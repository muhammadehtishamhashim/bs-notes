...
import { bsCsSource as source } from '@/lib/source'
    ...
    >
      <div className='relative flex @sm:flex-row flex-col items-start @sm:items-center gap-2'>
        ...
        <div className='ml-auto @sm:flex flex hidden shrink-0 flex-row items-center justify-end gap-2'>
          ...
          <ViewOptions
            githubUrl={`https://github.com/${owner}/${repo}/blob/main/content/bs-cs/${page.path}`}
...
export async function generateMetadata(
  ...
  const description =
    page.data.description ?? 'BS Computer Science Notes'
