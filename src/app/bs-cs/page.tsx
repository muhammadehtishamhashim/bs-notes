...
export default function BsCsPage(): ReactElement {
  return (
    <main className='mx-auto flex w-full max-w-[1400px] flex-col px-4 py-16'>
      <h1 className='font-semibold text-2xl md:text-3xl'>BS Computer Science</h1>
      ...
      <Semester 
        ...
        basePath="/bs-cs"
        enabledSemesters={[]} // No semesters enabled yet as per request/status
      />
    </main>
  )
}
